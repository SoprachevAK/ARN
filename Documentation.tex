  ...
  \begin{center}
    \begin{tikzpicture}
      \begin{umlpackage}{ARN}
        \umlclass[]{AR Unit}{}{}
        \umlclass[x=3]{POS Unit}{}{}
        \umlclass[x=6]{GPS Unit}{}{}
        \umlclass[x=1.5, y=-2]{POS + AR SubUnit}{}{}
        \umlclass[x=3, y=-4]{POS + AR + GPS SubUnit}{}{}

        \umlinherit[]{AR Unit}{POS + AR SubUnit}
        \umlinherit[]{POS Unit}{POS + AR SubUnit}
        \umlinherit[]{POS + AR SubUnit}{POS + AR + GPS SubUnit}
        \umlinherit[]{GPS Unit}{POS + AR + GPS SubUnit}
      \end{umlpackage}
    \end{tikzpicture}
  \end{center}
    ...
    \subsection{POS Unit}
      \subsubsection{Задача позиционирования}
        ...
        \subsubsection{Вычисление угла между системами с учётом погрешности}
          ...
          Рассмотим худший вариант, когда погрешность максимальна, и реальная позиция максимально отдолены от её измерения и находятся в точках $E'_1$ и $E'_2$.
  ...
  \section{Надстройки}
    \subsection{Pos + AR subUnit}
      \vbox{
        ...
        \begin{itemize}
          \item AREstimateGenerator --- отправляет событие OnEstimateAdd при обнаружение метки
